...
const ATF_CODES = [
  ...
  { value: 'ATF1', label: 'ATF1 - Facilities dirty or unclean' },
  { value: 'ATF2', label: 'ATF2 - Insufficient lighting' },
  { value: 'ATF3', label: 'ATF3 - Not enough toilets per ratio' },
  { value: 'ATF4', label: 'ATF4 - No hot/cold running water' },
  { value: 'ATF5', label: 'ATF5 - Out of soap/towels/paper' },
  { value: 'ATF6', label: 'ATF6 - Structural damage or leaks' },
  { value: 'ATF7', label: 'ATF7 - Poor ventilation' },
  { value: 'ATF8', label: 'ATF8 - Sanitary bins full/missing' },
  { value: 'ATF9', label: 'ATF9 - Other' },
]

const ATF_ITEMS = [
  { key: 'atfSeparateToilets', label: 'Are separate, clean, and well-lit toilets provided for male and female employees?' },
  { key: 'atfRatio', label: 'Is there at least 1 toilet for every 15 employees (up to 100 employees)?' },
  { key: 'atfWater', label: 'Are all washbasins supplied with a reliable stream of clean, running hot and cold water?' },
  { key: 'atfSupplies', label: 'Are sanitary hand soaps, liquid dispensers, and clean hand-drying towels continuously supplied?' },
  { key: 'atfStructure', label: 'Are toilet rooms completely structural, secure, properly ventilated, and free from leaks?' },
  { key: 'atfBins', label: 'Are dedicated, closed sanitary bins provided in female toilet blocks and emptied on a strict roster?' },
]

const ITEM_METADATA = {
  atfSeparateToilets: { label: 'Separate & Clean Toilets', svg: '<path stroke-linecap="round" stroke-linejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />' },
  atfRatio: { label: 'Toilet Ratio (1 per 15)', svg: '<path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />' },
  atfWater: { label: 'Hot & Cold Water', svg: '<path stroke-linecap="round" stroke-linejoin="round" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" />' },
  atfSupplies: { label: 'Soaps & Towels', svg: '<path stroke-linecap="round" stroke-linejoin="round" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />' },
  atfStructure: { label: 'Structural & Ventilated', svg: '<path stroke-linecap="round" stroke-linejoin="round" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />' },
  atfBins: { label: 'Sanitary Bins', svg: '<path stroke-linecap="round" stroke-linejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />' },
};
...
function AtfsPage() {
  ...
  const [deviations, setDeviations] = useState({
    atfs: buildInitialDeviationState(ATF_ITEMS),
  })
  ...
  async function handleSubmit(event) {
    ...
    const payload = {
      ...
      formPayload: {
        ...
        deviations: {
          atfs: sectionToLabels(ATF_ITEMS, deviations.atfs, ATF_CODES),
        },
      },
    }
  ...
  return (
    <section className="pb-32 flex flex-col items-center">
      <header className="w-full flex items-center justify-between px-4 pt-3 pb-4 bg-white/40 backdrop-blur-xl border-b border-white/50 shadow-sm rounded-none mb-4">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-slate-900 font-bold text-base leading-tight">Ablution & Sanitation</span>
          </div>
        </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        {renderSection('atfs', 'Ablution & Sanitation Check', ATF_ITEMS, ATF_CODES)}
