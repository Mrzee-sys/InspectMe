...
import { Flame, DoorOpen, ShieldAlert } from 'lucide-react';
...
const fireInspections = [
  ...
  },
  {
    ...
    to: '/inspections/health-safety/emx',
...
export default function FireAndLifeSafetyPage() {
  return (
      ...
      <header className="w-full flex items-center justify-between px-4 pt-3 pb-4 bg-white/40 backdrop-blur-xl border-b border-white/50 shadow-sm rounded-none mb-3">
        <div className="flex items-center gap-3">
          <div className="relative flex items-center justify-center w-9 h-11">
            ...
            <span className="absolute text-red-600 font-extrabold text-[11px] mt-0.5">IM</span>
          </div>
          <div className="flex flex-col">
            <span className="text-slate-600 font-semibold text-sm leading-tight tracking-wide">InspectMe</span>
            <span className="text-slate-900 font-bold text-[1.15rem] leading-tight">Fire & Life Safety</span>
          </div>
        </div>
